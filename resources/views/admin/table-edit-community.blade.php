    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{url('/e-vote/admin/community')}}" class="nav-link active">Edit Community</a>
                </li>
            </ul>
                ...
                <div class="container">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{url('/e-vote/admin/community/update/'.$community->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control"
                                        placeholder="Deskripsi Komunitas"> {{ $community->description }} </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="phone" class="form-control"
                                        placeholder="Nomor Telepon"> {{ $community->phone }} </textarea>
