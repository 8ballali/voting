              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <td>{{ $ca->user_phone }}</td>
                    <td>{{ $ca->user_id }}</td>
                    <td><img src="{{ url('/').'/data_file/'.$ca->file }}" height="30px" width="30px" /></td> 

                    <td>
					            	<a href="/e-vote/admin/candidate/delete/{{ $ca->id }}" onClick="confirm('Delete entry?')" class="btn btn-danger btn-sm">Hapus</a>
