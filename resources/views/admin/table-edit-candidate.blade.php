    ...
    <div class="container">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/e-vote/admin/candidate/update/{{ $candidate->id }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Visi</label>
                            <textarea name="visi" class="form-control" placeholder="Visi Kandidat"> {{ $candidate->visi }} </textarea>
                        ...
                        <div class="form-group">
                            <label>Misi</label>
                            <textarea name="misi" class="form-control" placeholder="Misi Kandidat"> {{ $candidate->misi }} </textarea>
                        ...
                        <div class="form-group">
                            <label>Alamat</label>
                            <textarea name="alamat" class="form-control" placeholder="Alamat Kandidat"> {{ $candidate->alamat }} </textarea>
                        ...
                        <div class="form-group">
                            <label>TTL</label>
                            <textarea name="ttl" class="form-control" placeholder="TTL Kandidat"> {{ $candidate->ttl }} </textarea>
                        ...
                        <div class="form-group">
                            <label>Gender</label>
                            <textarea name="gender" class="form-control" placeholder="Alamat Kandidat"> {{ $candidate->gender }} </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="user_phone" class="form-control" placeholder="Nomor Telepon Kandidat"> {{ $candidate->user_phone }} </textarea>
                        ...
                        <div class="form-group">
                            <label>User ID</label>
                            <textarea name="user_id" class="form-control" placeholder="User ID"> {{ $candidate->user_id}} </textarea>
