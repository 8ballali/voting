...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('/style/dist/css/adminlte.min.cs')}}s">
</head>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="http://127.0.0.1:8000/e-vote/admin" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="http://127.0.0.1:8000/e-vote/admin/community/add" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Community</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="http://127.0.0.1:8000/e-vote/admin/community/edit/{id}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Community</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="http://127.0.0.1:8000/e-vote/admin/community/delete/{id}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
    ...
    <!-- Main content -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Komunitas Mobil Semarang</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
