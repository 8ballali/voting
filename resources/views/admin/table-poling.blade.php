                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $p->title }}</td>
                                    <td>{{ $p->description }}</td>
                                    <td>{{ Carbon\Carbon::parse($p->start_at)->format('d-m-Y H:i:s') }}</td>
                                    <td>{{ Carbon\Carbon::parse($p->stop_at)->format('d-m-Y H:i:s') }}</td>



                                    <td>
                                        <a href="{{url('/e-vote/admin/poling/delete/'. $p->id )}}"
                                            onClick="confirm('Delete entry?')" class="btn btn-danger btn-sm">Hapus</a>
                                        <a href="{{url('/e-vote/admin/poling/edit/'.$p->id )}}" class="btn btn-warning">Edit</a>
                                    </td>
