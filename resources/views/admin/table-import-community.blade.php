...
<div class="wrapper">
    ...
    <div class="container">
		...
		<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<form method="post" action="/e-vote/admin/community/import-excel" enctype="multipart/form-data">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">CAN Cr{{ asset('/style/')}}</a>.</strong> All rights reserved.
  </footer>
