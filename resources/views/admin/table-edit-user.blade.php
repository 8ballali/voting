                ...
                <div class="card-body">
                    <form method="post" action="/e-vote/admin/user/update/{{ $user->id }}">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="name" class="form-control" placeholder="Nama Komunitas" value=" {{ $user->name }}">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <textarea name="email" class="form-control" placeholder="Deskripsi Komunitas"> {{ $user->email }} </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="phone" class="form-control" placeholder="Nomor Telepon"> {{ $user->phone }} </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="community_id" class="form-control" placeholder="Comunity ID"> {{ $user->community_id }} </textarea>
                        ...
                        <div class="form-group">
                            <label>Role</label>
                            <textarea name="role" class="form-control" placeholder="Role"> {{ $user->role }} </textarea>
