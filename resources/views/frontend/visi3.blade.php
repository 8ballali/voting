...
<body>
    ...
    <div class="container">
        <section id="about" class="about">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="images/ketiga.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-8 pt-4 pt-lg-0 content">
                    <div class="row">
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong> Nama Lengkap :</strong> <span>Ucok
                                        Kemrucok</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong> Komunitas :</strong> <span>Ayla</span>
                                </li>
                                <li><i class="bi bi-chevron-right"></i> <strong> Alamat :</strong> <span>Gunung
                                        Pati</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Tempat/Tgl Lahir :</strong> <span>Pati,
                                        30 Juni 1978</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Jenis Kelamin :</strong>
                                    <span>Laki-Laki</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Telepon :</strong>
                                    <span>+062122342123</span></li>
                        </div>
                    </div>
