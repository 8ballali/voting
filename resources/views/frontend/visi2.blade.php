...
<html lang="en">
  ...
  <body>
    ...
    <section id="about" class="about">
          ...
          <div class="row">
            <div class="col-lg-4">
              <img src="images/kedua.jpg" class="img-fluid" alt="">
            </div>
            <div class="col-lg-8 pt-4 pt-lg-0 content">
              <div class="row">
                <div class="col-lg-6">
                  <ul>
                    <li><i class="bi bi-chevron-right"></i> <strong> Nama Lengkap   :</strong> <span>Ujang Kemujang</span></li>
                    <li><i class="bi bi-chevron-right"></i> <strong> Komunitas      :</strong> <span>Sirion</span></li>
                    <li><i class="bi bi-chevron-right"></i> <strong> Alamat         :</strong> <span>Pekunden</span></li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul>
                    <li><i class="bi bi-chevron-right"></i> <strong>Tempat/Tgl Lahir    :</strong> <span>Semarang, 30 Maret 1975</span></li>
                    <li><i class="bi bi-chevron-right"></i> <strong>Jenis Kelamin       :</strong> <span>Laki-Laki</span></li>
                    <li><i class="bi bi-chevron-right"></i> <strong>Telepon             :</strong> <span>+062122342123</span></li>
                </div>
              </div>
        ...
        <div class="section-title mt-5">
            ...
            <h2>Misi</h2>
              ...
              <ul class="list-group">
                <li class="list-group-item">Membuat Mobil</li>
                <li class="list-group-item">Merancang Mobil</li>
                <li class="list-group-item">Mendesain Mobil</li>
