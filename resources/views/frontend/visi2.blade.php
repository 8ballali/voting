            ...
            <div class="row">
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content">
                    <div class="row">
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong> Nama Lengkap :</strong> <span>Ujang
                                        Kemujang</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong> Komunitas :</strong>
                                    <span>Sirion</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong> Alamat :</strong> <span>Pekunden</span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Tempat/Tgl Lahir :</strong>
                                    <span>Semarang, 30 Maret 1975</span></li>
