          ...
          <div class="row">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content">
              <div class="row">
                <div class="col-lg-6">
                  <ul>
                    <li><i class="bi bi-chevron-right"></i> <strong> Nama Lengkap   :</strong> <span>Udin Awaludin</span></li>
                    <li><i class="bi bi-chevron-right"></i> <strong> Komunitas      :</strong> <span>Livina</span></li>
                    <li><i class="bi bi-chevron-right"></i> <strong> Alamat         :</strong> <span>Boyolali</span></li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul>
                    <li><i class="bi bi-chevron-right"></i> <strong>Tempat/Tgl Lahir    :</strong> <span>Semarang, 29 Mei 1985</span></li>
