...
<body>
    ...
    <div class="container">
                        ...
                        <div class="col-lg-6">
                            <ul>
                                ...
                                <li><i class="bi bi-chevron-right"></i> <strong> Komunitas :</strong>
                                    <span>{{\DB::table('community')->where('id', \App\User::find($c->user_id)->community_id)->first()->name}}</span>
                                </li>
                                <li><i class="bi bi-chevron-right"></i> <strong> Alamat :</strong>
                                    <span>{{$c->alamat}}</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
        ...
        <ul class="list-group">
            <li class="list-group-item">{{$c->misi}}</li>
